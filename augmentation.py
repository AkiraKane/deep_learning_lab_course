...
if __name__ == "__main__":
  ...
  print("orig_arr shape: " + str(orig_arr.shape))
  #print(zoomed.shape)
  #cropped = t.crop(zoomed, 32, 32)
  #transformed = t.process(np.reshape(orig_arr, (3, 32, 32)), n=1)
  transformed = t.elastic_deformation(np.reshape(orig_arr, (3,32,32)))
  img = Image.fromarray(np.uint8(np.reshape(transformed, (32,32,3))))
  img.save("augmented.png", "png")